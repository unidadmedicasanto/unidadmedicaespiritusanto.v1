...
<head>
    ...
    <!-- Responsive Stylesheet -->
     ...
     <style>
    .btn-publicacion {
    background-color: #5ba2db; /* Color de fondo verde */
...
.btn-publicacion:hover {
    background-color: #5ba2db; /* Color más oscuro al pasar el cursor */
    color: #e8f5e9; /* Texto ligeramente más claro */
    box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2); /* Sombra */
}

.btn-publicacion:active {
    background-color: #1e7e34; /* Color al hacer clic */
    box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3); /* Sombra más pequeña */
}
...
.project-item .position-relative {
    margin-bottom: 10px; /* Espacio entre imagen y contenido */
}
...
.project-item img {
    ...
    object-fit: cover;    /* Recortar la imagen para que encaje sin deformarse */
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            >
                            <a href="https://www.tiktok.com/@espiritusanto3111"
                            target="_blank">
            ...
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                        ...
                        <a href="https://www.minsalud.gov.co/Portada/index.php" class="dropdown-item" target="_blank">Ministerio de Salud</a>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start text-primary pe-3">Unidad Medica Espiritu Santo</h6>
                        <h1 class="display-6 mb-4">Contamos con mas de 10 años de experiencia</span></h1>
                        <p>Contamos con un equipo altamente capacitado y comprometido, compuesto por profesionales dedicados a brindar un servicio excepcional. Nuestro personal combina experiencia, conocimiento y un trato humano para garantizar la satisfacción y confianza de nuestros clientes.</p>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.24s">
                    <a class="service-item d-block rounded text-center h-100 p-4" >
                        <img class="img-fluid rounded mb-4" src="img/WhatsApp Image 2022-12-19 at 9.34.38 AM.jpeg" alt="">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start text-success pe-3">¿Por que deberias de confiar en nosotros?</h6>
                        <h1 class="display-6 mb-4">Tenemos los mejores servicios en salud</h1>
                        <p class="mb-4">Estamos dedicados a proporcionar atención médica confiable y efectiva en cada uno de nuestros servicios, asegurando siempre el bienestar y la satisfacción de nuestros pacientes. ¡Tu salud es nuestra prioridad!</p>
                        <div class="row g-4">
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="img/facebook_icon.svg.png" alt="">
                        <div class="team-text">
                            ...
                            <div class="team-social">
                                <a class="btn btn-square btn-primary rounded-circle"  href="https://www.facebook.com/umesantoac"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="team-item text-center p-4">
                        ...
                        <div class="team-text">
                            ...
                            <div class="team-social">
                                ...
                                <a class="btn btn-square btn-primary rounded-circle" href="https://www.instagram.com/unidadmedicaespiritusanto/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item text-center p-4">
                        ...
                        <div class="team-text">
                            ...
                            <div class="team-social">
                                <a class="btn btn-square btn-primary rounded-circle" href="https://www.tiktok.com/@espiritusanto3111">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="testimonial-item bg-light rounded p-4">
                    ...
                    <p class="mb-0">La atención en urgencias fue rápida y efectiva. Estoy muy agradecida por el profesionalismo del equipo médico.</p>
                </div>
                <div class="testimonial-item bg-light rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                    ...
                    <p class="mb-0">El personal es muy atento y profesional. Me siento en buenas manos cada vez que visito sus instalaciones.</p>
                </div>
                <div class="testimonial-item bg-light rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                    ...
                    <p class="mb-0">Gracias a la consulta externa, mi problema de salud fue diagnosticado y tratado de manera eficaz. ¡Excelente servicio!</p>
                </div>
            </div>
        </div>
    </div>
